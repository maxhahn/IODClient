...
data_dir = './experiments/simulation/iod_comparison_find_correct'
...
num_clients_options = [2] #,10] #,10]
num_samples_options = [1_000_000] #,10000] #,5000][50_000]
split_perc_options = [[0.5, 0.5]]
